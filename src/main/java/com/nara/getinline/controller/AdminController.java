package com.nara.getinline.controller;

import com.nara.getinline.constant.EventStatus;
import com.nara.getinline.constant.PlaceType;
...
public class AdminController {
    ...
    @GetMapping("/events")
    public ModelAndView adminEvents(Integer placeId, String eventName, EventStatus eventStatus,
